...
def convert_item_frame(frame):
    ...
    if frame["Item"]["id"].value in Util.POTION_TYPES:
        frame["Item"], temp = Util.convert_potion_item(frame["Item"], 0) 
    return frame
